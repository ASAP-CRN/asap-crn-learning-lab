...
###########
adata = sc.read_h5ad(sn_mmc_pheno_filename_v2)
...
# %%
scanvi_model_filename = local_data_path / f"asap-{dataset_team}.SN.05_scanvi_model_v2"

scanvi_model.save(scanvi_model_filename, overwrite=True)
# 6. Save the latent space
# output file neame
sn_scanvi_filename = local_data_path / f"asap-{dataset_team}.SN.05_scanvi_v2.h5ad"
